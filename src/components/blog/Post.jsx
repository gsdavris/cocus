	...
	return (
		<div className="mb-8 shadow-lg hover:shadow rounded-lg break-words">
			<figure className="overflow-hidden mb-4">
				<Image { ...post?.featuredImage?.node } width="400" height="225" layout="fill" containerClassNames="w-96 sm:-w-600px md:w-400px h-56 sm:h-338px md:h-225px rounded-t-lg" class="rounded-t-lg" title={post?.title ?? ''}/>
			</figure>
